...
export const RaceDetailsPage = () => {
  ...
  const renderRaceContent = (
    race: Race,
    participants: { [id: ParticipantId]: Participant | undefined }
  ) => {
    const maybeRaceParticipants = race.participants.map(
      ...
      <>
        ...
        <Box display="flex" justifyContent="flex-end">
          <TextField
            ...
            placeholder="$2137.44"
          />
          <Button variant="outlined" sx={{ marginLeft: 2, paddingX: 18 }}>
            Bet
          </Button>
        </Box>
      </>
